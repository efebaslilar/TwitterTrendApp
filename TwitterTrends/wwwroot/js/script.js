        ...
        .then(data => {
            ...
            /*    const trendLi = document.createElement('li');*/
                trendcontent += `<li>
                 <div class="card-content">
                     <span class="header"><span class="index">${(i + 1)} · </span>${data[i].name}</span>
                     <span class="info">
                     <span class="trending-time">Trending since ${data[i].trendingHour} hours ${data[i].trendingMinute} minutes.</span>
                     <br>
                     <span class="tweet-amount">${data[i].count}K Tweets</span>
                     <a href="#">HASHTAG</a>
                   </span>
                 </div></li>`;
         ...
         /*       const hastagLi = document.createElement('li');*/
                hastagcontent += `<li>
                                      ...
                                      <span class="title">${data[i].name}</span><br>
                                      <span class="description">${data[i].count}k Tweet</span></li>`;
